...
public class Conversionlongitud extends AppCompatActivity {

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.conversionlongitud);
		
		findViewById(R.id.etconversiones);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvconversionlongitud);
	...
	public void kilometros(View view){
		
		EditText num1 = (EditText)findViewById(R.id.etconversiones);
		...
		double mt = dbnum1*1000;
		String resultado = String.valueOf(mt);
		total.setText(resultado+" "+"Metros");
		}
	}
	
	public void metros(View view){
		...
		double dbnum1 = Double.parseDouble(num1.getText().toString());
		double km = dbnum1/1000;
		String resultado = String.valueOf(km);
		total.setText(resultado+" "+"Kilometros");
		}
	}
