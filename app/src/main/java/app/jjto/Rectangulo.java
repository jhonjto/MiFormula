...
public class Rectangulo extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.etrectangulo1);
		findViewById(R.id.etrectangulo2);
...
/*	private Intent sIntent() {
    ...
    TextView text = (TextView)findViewById(R.id.tvrectangulo);
...
/*	@Override
	...
	public void rectangulo(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etrectangulo1);
		EditText num2 = (EditText)findViewById(R.id.etrectangulo2);
