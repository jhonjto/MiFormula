...
public class Rombo extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.etrombo1);
		findViewById(R.id.etrombo2);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvrombo);
...
/*	@Override
	...
	public void rombo(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etrombo1);
		EditText num2 = (EditText)findViewById(R.id.etrombo2);
