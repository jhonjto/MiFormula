...
public class Logaritmonatural extends AppCompatActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.logaritmonatural);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvlogaritmon);
...
/*	@Override
	...
	public void logaritmon(View view){
		...
		double logaritmo = Math.log(dbnum1);
