...
public class Potencias extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.potencias);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvpotencias);
...
/*	@Override
	...
	public void calcularpotencia(View view){
		...
		double resultadopotencia = Math.pow(dbnum1, dbnum2);
		String resultado = String.valueOf(resultadopotencia);
