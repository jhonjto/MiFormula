...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvareacirculo);
...
/*	@Override
	...
	public void pi(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etpi);
		...
		double resultado;
		resultado = Math.PI * Math.pow(dbnum1 , 2);
