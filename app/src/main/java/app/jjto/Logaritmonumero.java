...
public class Logaritmonumero extends AppCompatActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.logaritmonumero);
...
/*	private Intent sIntent() {
        ...
        TextView text = (TextView)findViewById(R.id.tvlogaritmonum);
...
/*	@Override
	...
	public void logaritmonum(View view){
		...
		double logaritmo = Math.log10(dbnum1);
		String resultado = String.valueOf(logaritmo);
		resultadofinal.setText("Logaritmo de "+dbnum1+" es igual a "+resultado);
		}
	}
