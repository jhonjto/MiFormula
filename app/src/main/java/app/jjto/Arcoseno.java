...
public class Arcoseno extends AppCompatActivity{

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.arcoseno);
		
		findViewById(R.id.etarcoseno);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvarcoseno);
...
/*	@Override
	...
	public void arcoseno(View view){
		
		EditText num1 = (EditText)findViewById(R.id.etarcoseno);
		TextView totalarcoseno = (TextView)findViewById(R.id.tvresultado);
		if(num1.length() <= 0){
			Toast toast =
