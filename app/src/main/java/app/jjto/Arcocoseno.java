...
public class Arcocoseno extends AppCompatActivity{

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.arcocoseno);
		
		findViewById(R.id.etarco1);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvarcocoseno);
...
/*	@Override
	...
	public void arcocoseno(View view){
		
		EditText num1 = (EditText)findViewById(R.id.etarco1);
		TextView totalarcocoseno = (TextView)findViewById(R.id.tvresultado);
		if(num1.length() <= 0){
			Toast toast =
