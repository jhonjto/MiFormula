...
public class Suma extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.etsuma1);
		findViewById(R.id.etsuma2);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvsuma);
...
/*	@Override
	...
	public void calcularsuma(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etsuma1);
		EditText num2 = (EditText)findViewById(R.id.etsuma2);
		TextView totalsuma = (TextView)findViewById(R.id.tvresultado);
		...
		double sumafinal = dbnum1+dbnum2;
		String resultado = String.valueOf(sumafinal);
		totalsuma.setText(resultado);
