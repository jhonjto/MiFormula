...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvconversiones);
...
/*	@Override
	...
	public void grados(View view){
		...
		double radianes = Math.toRadians(dbnum1);
		String resultado = String.valueOf(radianes);
		total.setText(resultado+" "+"Radianes");
		}
	}
	...
	public void radianes(View view){
		...
		TextView total = (TextView)findViewById(R.id.tvresultado);
		double dbnum1 = Double.parseDouble(num1.getText().toString());
		double grados = Math.toDegrees(dbnum1);
		String resultado = String.valueOf(grados);
		total.setText(resultado+" "+"Grados");
