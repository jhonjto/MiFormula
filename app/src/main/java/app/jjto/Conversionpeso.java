...
public class Conversionpeso extends AppCompatActivity {

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.conversionpeso);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvconversionespeso);
...
/*	@Override
	...
	public void kilogramos(View view){
		...
		double lb = dbnum1*2.2046;
		String resultado = String.valueOf(lb);
		total.setText(resultado+" "+"Libras");
		}
	}
	...
	public void libras(View view){
		...
		double dbnum1 = Double.parseDouble(num1.getText().toString());
		double kg = dbnum1/2.2046;
		String resultado = String.valueOf(kg);
		total.setText(resultado+" "+"Kilogramos");
		}
	}
