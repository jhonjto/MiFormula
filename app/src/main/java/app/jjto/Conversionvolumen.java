...
public class Conversionvolumen extends AppCompatActivity {

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.conversionvolumen);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvconversionvolumen);
...
/*	@Override
	...
	public void litros(View view){
		...
		double ac = dbnum1/0.0010000;
		String resultado = String.valueOf(ac);
		total.setText(resultado+" "+"Mililitros");
		}
	}
	
	public void mililitros(View view){
		...
		double dbnum1 = Double.parseDouble(num1.getText().toString());
		double km = dbnum1/1000.0;
		String resultado = String.valueOf(km);
		total.setText(resultado+" "+"Litros");
		}
	}
