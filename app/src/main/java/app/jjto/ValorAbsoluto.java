...
public class ValorAbsoluto extends AppCompatActivity {

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.valorabsoluto);
		
		findViewById(R.id.etvalorab);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvvalorabsoluto);
...
/*	@Override
	...
	public void valorabsoluto(View view){
		
		EditText num1 = (EditText)findViewById(R.id.etvalorab);
		TextView totalvalor = (TextView)findViewById(R.id.tvresultado);
		if(num1.length() <= 0){
			Toast toast =
		...
		double vabsoluto = Math.abs(dbnum1);
		String resultado = String.valueOf(vabsoluto);
		totalvalor.setText(resultado);
