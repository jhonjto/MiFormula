...
public class Resta extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.etresta1);
		findViewById(R.id.etresta2);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvresta);
...
/*	@Override
	...
	public void calcularresta(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etresta1);
		EditText num2 = (EditText)findViewById(R.id.etresta2);
		TextView totalresta = (TextView)findViewById(R.id.tvresultado);
		...
		double restafinal = dbnum1-dbnum2;
		String resultado = String.valueOf(restafinal);
		totalresta.setText(resultado);
