...
public class Coseno extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.coseno);
		
		findViewById(R.id.etcoseno);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvcoseno);
...
/*	@Override
	...
	public void coseno(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etcoseno);
		...
		total.setText("Coseno de "+dbnum1+"� = "+resultado);
		}
	}
