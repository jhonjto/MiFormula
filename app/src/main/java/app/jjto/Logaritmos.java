...
public class Logaritmos extends AppCompatActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.logaritmos);
		
		findViewById(R.id.etpotenciaa);
		findViewById(R.id.etpotenciab);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvlogaritmos);
	...
	public void logaritmo(View view){
		EditText num1 = (EditText)findViewById(R.id.etpotenciaa);
		EditText num2 = (EditText)findViewById(R.id.etpotenciab);
		...
		double logaritmo = Math.log10(dbnum1)/Math.log10(dbnum2);
		String resultado = String.valueOf(logaritmo);
		resultadofinal.setText("Logaritmo en base " +dbnum2+" de "+dbnum1+" es igual a "+resultado);
		}
	}
