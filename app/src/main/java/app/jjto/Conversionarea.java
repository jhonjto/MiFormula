...
public class Conversionarea extends AppCompatActivity {

	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.conversionarea);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvconversionarea);
	...
	public void hectareas(View view){
		...
		double ac = dbnum1*2.4711;
		String resultado = String.valueOf(ac);
		total.setText(resultado+" "+"Acres");
		}
	}
	
	public void acres(View view){
		...
		double dbnum1 = Double.parseDouble(num1.getText().toString());
		double km = dbnum1/2.4711;
		String resultado = String.valueOf(km);
		total.setText(resultado+" "+"Hectareas");
		}
	}
