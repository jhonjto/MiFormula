...
public class EditarFormulas extends AppCompatActivity {
	TextView tvnombre;
	EditText etbusqueda;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.editarformulas);
...
/*	@Override
	...
	public void editar(View view){
		//Intent i = new Intent("com.sqlite.base.datos.CargarFormulas");
		//startActivity(i);
		try{
		...
		Formulas editar = new Formulas(this);
		editar.abrir();
		//String bN = editar.getN(lb);
		String bT = editar.getT(lb);
		etcontenido.setText(bT);
		editar.editar(lb, nombre, contenido);
		editar.cerrar();
		}catch(Exception e){
