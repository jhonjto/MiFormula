...
public class Division extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.etdivision1);
		findViewById(R.id.etdivision2);
...
/*	private Intent sIntent() {
		...
		TextView text = (TextView)findViewById(R.id.tvdivision);
...
/*	@Override
	...
	public void calculardivision(View view){
		...
		EditText num1 = (EditText)findViewById(R.id.etdivision1);
		EditText num2 = (EditText)findViewById(R.id.etdivision2);
		TextView totaldivision = (TextView)findViewById(R.id.tvresultado);
		...
		double divisionfinal = dbnum1/dbnum2;
		String resultado = String.valueOf(divisionfinal);
		totaldivision.setText(resultado);
	}
	}
