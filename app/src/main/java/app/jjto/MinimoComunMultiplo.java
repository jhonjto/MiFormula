...
public class MinimoComunMultiplo extends AppCompatActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.minimocomunmultiplo);
...
/*	@Override
	...
	public void mcd(View view){
		...
		if(num1.length() <= 0 || num2.length() <= 0){
			...
			while(dbnum1 != dbnum2){
				if(dbnum1 > dbnum2){
					dbnum1 = dbnum1 - dbnum2;
				}else{
					dbnum2 = dbnum2 - dbnum1;
				}
			}
			mcd = dbnum2;
			mcm = n1*n2/mcd;
			
			String resultado = String.valueOf(mcm);
